...
public class StaffCollection {
    ...
    {
        getStaffList().sort(new SortByPersonName());
    }

    public void sortEmployeeIdNumber()
    {
        getStaffList().sort(new SortByEmployeeIdNumber());
    }
    ...
    public void sortTeacherPositionTitle()
    {
        ...
        teacherList.sort(new SortByTeacherPositionTitle());
    }
    ...
    public void sortSupportStaffPositionTitle()
    {
        ...
        supportStaffList.sort(new SortBySupportStaffPositionTitle());
    }
