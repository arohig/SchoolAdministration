...
public class SchoolAdministration {
    ...
    public static void main(String[] args) {
        ...
        JanitorialStaff janitorialStaff1 = new JanitorialStaff("Jane", "", "Grange", 801104823, "04/27/1991", "Female", "Roam Street, Edmonton AB T9W4Q7", 20146, List.of("Richard Thompson", "Ally Thompson"));
