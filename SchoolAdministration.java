...
public class SchoolAdministration {
    ...
    public static void main(String[] args) {
        ...
        VicePrincipal vicePrincipal1 = new VicePrincipal("Preeti", "Jamal", "Agarwal", 801016429, "02/19/1981", "Female", "Pilrose Mansion, Edmonton AB T0B0P1", 10026, List.of("Rhoe Tan", "Aarti Bhatt"));
