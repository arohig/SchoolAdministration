...
public class SchoolAdministration {
    ...
    public static void main(String[] args) {
        ...
        Person person1 = new Person("Tristan", "Joe", "Williamson",
                587071937, "06/12/2003", "Male",
                "78 Neon Street, Sherwood Park AB T9G2O1");

        //create 60 Student objects
        Student student1 = new Student("Tristan", "James", "Holmes",
                587467519, "03/26/2004", "Male",
                "23 Bush Avenue, Edmonton AB T7U9R6", 1002085, 534,
                "APE3", 11,
                List.of("Biology 20", "Computing Science 20", "Horticulture 20", "Physics 20", "Math 20"),
                List.of("James John Holmes", "Jill Stew Holmes"), List.of("William Hendrick", "Shelly Holt"));
        ...
        Parent parent5 = new Parent("Tristan", "James", "Holmes", 587467519, "03/26/2004", "Male", "23 Bush Avenue, Edmonton AB T7U9R6");
        schoolPersonList.addPerson(parent5);
        ...
        EmergencyContact emergencyContact3 = new EmergencyContact("Tristan", "James", "Holmes",
                587467519, "Family Friend");
        schoolPersonList.addPerson(emergencyContact3);
        ...
        Staff staff1 = new Staff("Michael", "Lynch", "Tale",
                780016302, "02/17/1992", "Male",
                "BlackRose Apartments, Edmonton AB T9H2D4", 30265,
                List.of("Brant Spike", "Shane Damsy"));
